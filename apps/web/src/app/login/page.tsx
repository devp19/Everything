...
export default function Login() {
  ...
  /> */}
      ...
      <main className="flex-1 flex items-center justify-center text-white">
        ...
        onClick={() => router.push('/')}
        variant={'ghost'}
        className="group text-sm transition-all absolute top-4 left-4 cursor-pointer text-muted-foreground hover:text-primary flex items-center gap-1"
      >
        <span className="transition-all group-hover:pr-2">
